...
{
	public class ScheduleByChannelProjection : EventModel<ScheduleByChannel>
	{
		public ScheduleByChannelProjection(IObservable<CommittedEvent> events, ScheduleByChannel modelSnapshot = null, int serial = 0)
